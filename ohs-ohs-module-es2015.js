...
let JobIncidentComponent = class JobIncidentComponent {
    constructor(dialogService, fb) {
        this.dialogService = dialogService;
        this.fb = fb;
        this.alive = true;
    ...
    openIncidentform(dialog) {
        this.dialogService.open(dialog, { context: 'this is some additional data passed to dialog' });
    }
};
JobIncidentComponent.ctorParameters = () => [
    { type: _nebular_theme__WEBPACK_IMPORTED_MODULE_3__["NbDialogService"] },
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
];
...
let OhsRoutingModule = class OhsRoutingModule {
};
...
let OhsComponent = class OhsComponent {
    constructor() {
...
let ScopeComponent = class ScopeComponent {
    constructor(dialogService, fb) {
        this.dialogService = dialogService;
        this.fb = fb;
        this.alive = true;
...
//# sourceMappingURL=ohs-ohs-module-es2015.js.map