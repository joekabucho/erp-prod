(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["ohs-ohs-module"],{
...
/***/ "./node_modules/raw-loader/index.js!./src/app/ohs/documents/document.component.html":
/*!*********************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/ohs/documents/document.component.html ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"row\">\r\n  <div class=\"col-sm-12\">\r\n    <nb-card status=\"info\">\r\n      <nb-card-header>Documents list\r\n        <button nbButton status=\"success\" size=\"small\" (click)=\"open(dialog)\">Upload Document</button>\r\n      </nb-card-header>\r\n      <nb-card-body>\r\n\r\n        <nb-card class=\"col-sm-12 p-0 work-card\" *ngFor=\"let doc of documents\">\r\n          <nb-card-body>\r\n            <div class=\"work-title\">{{doc.name}}</div>\r\n            <div class=\"work-details\"><span class=\"work-data\">Description:</span> <span class=\"fetched-data\">{{doc.description}}</span></div>\r\n\r\n            <div class=\"d-flex justify-content-between\">\r\n              <div class=\"work-details\"><span class=\"work-data\">Status:</span>\r\n                <button nbButton hero status=\"{{doc.status}}\" size=\"small\" class=\"doc-btn\" (click)=\"openDetails(dialog1, doc)\">{{doc.statusMessage}}</button>\r\n              </div>\r\n\r\n              <div class=\"actions\">\r\n                <a href=\"{{doc.file}}\">Download</a>\r\n                <nb-icon icon=\"file-text-outline\" (click)=\"openDocs(dialog2)\"></nb-icon>\r\n              </div>\r\n            </div>\r\n\r\n          </nb-card-body>\r\n        </nb-card>\r\n\r\n      </nb-card-body>\r\n    </nb-card>\r\n  </div>\r\n</div>\r\n\r\n<ng-template #dialog let-data let-ref=\"dialogRef\">\r\n  <nb-card style=\"width: 25em;\">\r\n    <nb-card-header>Upload Document\r\n      <a (click)=\"ref.close()\" aria-label=\"Back\" style=\"float: right;\">\r\n        <nb-icon icon=\"close\"></nb-icon>\r\n      </a>\r\n    </nb-card-header>\r\n    <nb-card-body>\r\n      <form [formGroup]=\"docForm\">\r\n        <div class=\"form-group\">\r\n          <input type=\"file\" nbInput fullWidth id=\"inputFile\" class=\"p-0\" formControlName=\"file\">\r\n        </div>\r\n        <div class=\"form-group\">\r\n          <input type=\"text\" nbInput fullWidth id=\"inputName\" placeholder=\"File name\" formControlName=\"name\">\r\n        </div>\r\n        <div class=\"form-group\">\r\n          <textarea type=\"text\" nbInput fullWidth fieldSize=\"giant\" placeholder=\"Description\" formControlName=\"description\"></textarea>\r\n        </div>\r\n      </form>\r\n    </nb-card-body>\r\n    <nb-card-footer>\r\n      <button nbButton status=\"success\" size=\"small\" style=\"float: right;\" (click)=\"addScope(workForm.value)\">submit</button>\r\n    </nb-card-footer>\r\n  </nb-card>\r\n</ng-template>\r\n\r\n\r\n<ng-template #dialog1 let-data let-ref=\"dialogRef\">\r\n  <nb-card style=\"width: 25em;\">\r\n    <nb-card-header>Approve Document\r\n      <a (click)=\"ref.close()\" aria-label=\"Back\" style=\"float: right;\">\r\n        <nb-icon icon=\"close\"></nb-icon>\r\n      </a>\r\n    </nb-card-header>\r\n    <nb-card-body class=\"approver-card\">\r\n      <div class=\"work-details\">\r\n        <span class=\"work-data\">{{hod}}</span>\r\n        <span class=\"fetched-data\">\r\n          <nb-checkbox [checked]=\"true\" status=\"success\">Approved</nb-checkbox>\r\n        </span>\r\n      </div>\r\n\r\n      <div class=\"work-details\">\r\n        <span class=\"work-data\">{{pm}}</span>\r\n        <span class=\"fetched-data\">\r\n          <nb-checkbox status=\"{{state}}\" (checkedChange)=\"toggle($event)\">{{message}}</nb-checkbox>\r\n        </span>\r\n      </div>\r\n\r\n      <div class=\"work-details\">\r\n        <span class=\"work-data\">{{technician}}</span>\r\n        <span class=\"fetched-data\">\r\n          <nb-checkbox status=\"{{state}}\" [checked]=\"false\">Pending</nb-checkbox>\r\n        </span>\r\n      </div>\r\n    </nb-card-body>\r\n  </nb-card>\r\n</ng-template>\r\n\r\n\r\n<ng-template #dialog2 let-data let-ref=\"dialogRef\">\r\n  <nb-card style=\"width: 25em;\">\r\n    <nb-card-header>View Document\r\n      <a (click)=\"ref.close()\" aria-label=\"Back\" style=\"float: right;\">\r\n        <nb-icon icon=\"close\"></nb-icon>\r\n      </a>\r\n    </nb-card-header>\r\n    <nb-card-body>\r\n      <img src=\"{{file}}\" alt=\"File\">\r\n    </nb-card-body>\r\n  </nb-card>\r\n</ng-template>\r\n"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/ohs/job/job-details/job-detail.component.html":
/*!*****************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/ohs/job/job-details/job-detail.component.html ***!
  \*****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"row p-2\">\r\n  <div class=\"col-12\">\r\n    <a href=\"#\" (click)=\"back()\" class=\"link back-link\" aria-label=\"Back\">\r\n      <nb-icon icon=\"arrow-back\"></nb-icon>\r\n    </a>\r\n  </div>\r\n</div>\r\n<nb-card accent=\"success\">\r\n  <nb-card-header>Job Detail</nb-card-header>\r\n  <nb-card-body>\r\n    <div class=\"row\">\r\n      <div class=\"col-md-4 col-sm-12\">\r\n        <nb-card class=\"detail-card\">\r\n          <nb-card-header>\r\n            <div class=\"detail\">{{job.name.title}}</div>\r\n          </nb-card-header>\r\n          <nb-card-body>\r\n            <div class=\"fetched-data\">{{job.name.name}}</div>\r\n            <!-- <div class=\"fetched-data\">{{job.name}}</div> -->\r\n          </nb-card-body>\r\n        </nb-card>\r\n\r\n        <nb-card class=\"detail-card\">\r\n          <nb-card-header>\r\n            <div class=\"detail\">{{job.hod.title}}</div>\r\n          </nb-card-header>\r\n          <nb-card-body>\r\n            <nb-icon icon=\"person\" style=\"color: #0095ff;\"></nb-icon>\r\n            <div class=\"fetched-data\">{{job.hod.name}}</div>\r\n          </nb-card-body>\r\n        </nb-card>\r\n\r\n        <nb-card class=\"detail-card\">\r\n          <nb-card-header>\r\n            <div class=\"m-auto detail\">{{job.technician.title}}</div>\r\n          </nb-card-header>\r\n          <nb-card-body>\r\n            <nb-icon icon=\"person\" style=\"color: #0095ff;\"></nb-icon>\r\n            <div class=\"fetched-data\">{{job.technician.name}}</div>\r\n          </nb-card-body>\r\n        </nb-card>\r\n\r\n        <nb-card class=\"detail-card\">\r\n          <nb-card-header>\r\n            <div class=\"detail\">{{job.status.title}}</div>\r\n          </nb-card-header>\r\n          <nb-card-body>\r\n            <nb-icon icon=\"checkmark-circle-2\" style=\"color: #00d68f;\"></nb-icon>\r\n            <div class=\"fetched-data\">{{job.status.message}}</div>\r\n          </nb-card-body>\r\n        </nb-card>\r\n\r\n        <nb-card class=\"detail-card\">\r\n          <nb-card-header>\r\n            <div class=\"detail\">{{job.hazard.title}}</div>\r\n          </nb-card-header>\r\n          <nb-card-body>\r\n            <nb-icon icon=\"alert-circle\" style=\"color: #ffaa00;\"></nb-icon>\r\n            <div class=\"fetched-data\">{{job.hazard.name}}\r\n              <ngb-rating [(rate)]=\"job.hazard.level\" [max]=\"3\" [ngStyle]=\"{'color': getColor(job.hazard.level)}\"></ngb-rating>\r\n            </div>\r\n          </nb-card-body>\r\n        </nb-card>\r\n      </div>\r\n\r\n      <div class=\"col-md-8 col-sm-12\">\r\n        <ngx-gmaps></ngx-gmaps>\r\n      </div>\r\n    </div>\r\n    <div class=\"row\">\r\n      <div class=\"col-md-6 col-sm-12\" *ngFor=\"let image of images\">\r\n      <nb-card size=medium status=\"info\" class=\"image-card\">\r\n        <nb-card-header>{{image}}</nb-card-header>\r\n        <nb-card-body>\r\n          <img class=\"safety\" src=\"assets/images/safety.jpg\" alt=\"safety\">\r\n        </nb-card-body>\r\n      </nb-card>\r\n    </div>\r\n    </div>\r\n  </nb-card-body>\r\n</nb-card>\r\n"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/ohs/job/job-incidents/job-incident.component.html":
/*!*********************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/ohs/job/job-incidents/job-incident.component.html ***!
  \*********************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"row\">\r\n  <div class=\"col-md-12 col-sm-12\">\r\n    <nb-card status=\"info\">\r\n      <nb-card-header class=\"d-flex justify-content-between\">Job closure incidents\r\n        <button nbButton status=\"success\" size=\"small\" (click)=\"openIncidentform(dialog)\">Add Incident</button>\r\n      </nb-card-header>\r\n      <nb-card-body>\r\n\r\n        <table class=\"table table-striped table-hover\">\r\n          <thead>\r\n          <tr>\r\n            <th *ngFor=\"let head of headElements\" scope=\"col\">{{head}}</th>\r\n          </tr>\r\n          </thead>\r\n          <tbody>\r\n            <tr *ngFor=\"let incident of incidents; index as i\">\r\n              <th scope=\"row\">{{ i + 1 }}</th>\r\n              <td>{{incident.name}}</td>\r\n              <td>{{incident.description}}</td>\r\n              <!-- <td>{{job.scope}}</td>\r\n              <td>{{job.hazardLevel}} <ngb-rating [(rate)]=\"job.rating\" [max]=\"3\" [ngStyle]=\"{'color': getColor(job.rating)}\"></ngb-rating></td>\r\n              <td>{{job.technician}}</td>\r\n              <td><button nbButton hero status=\"{{job.status}}\" size=\"small\" class=\"doc-btn\">{{job.statusMessage}}</button></td>\r\n              <td><i class=\"nb-edit\" (click)=\"editJob(dialog, job)\"></i></td>\r\n              <td><a [routerLink]=\"job.link\">Details</a></td> -->\r\n            </tr>\r\n          </tbody>\r\n        </table>\r\n\r\n      </nb-card-body>\r\n    </nb-card>\r\n  </div>\r\n</div>\r\n<ng-template #dialog let-data let-ref=\"dialogRef\">\r\n  <nb-card style=\"width: 25em;\">\r\n    <nb-card-header>Add Incident\r\n      <a (click)=\"ref.close()\" aria-label=\"Back\" style=\"float: right;\">\r\n        <nb-icon icon=\"close\"></nb-icon>\r\n      </a>\r\n    </nb-card-header>\r\n    <nb-card-body>\r\n      <form [formGroup]=\"incidentForm\">\r\n        <div class=\"form-group\">\r\n          <input type=\"text\" nbInput fullWidth id=\"inputName\" placeholder=\"Incident name\" formControlName=\"name\">\r\n        </div>\r\n        <div class=\"form-group\">\r\n          <textarea type=\"text\" nbInput fullWidth fieldSize=\"giant\" placeholder=\"Description\" formControlName=\"description\"></textarea>\r\n        </div>\r\n      </form>\r\n    </nb-card-body>\r\n    <nb-card-footer>\r\n      <button nbButton status=\"success\" size=\"small\" style=\"float: right;\">submit</button>\r\n    </nb-card-footer>\r\n  </nb-card>\r\n</ng-template>\r\n"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/ohs/job/job.component.html":
/*!**********************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/ohs/job/job.component.html ***!
  \**********************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"row\">\r\n  <div class=\"col-md-12 col-sm-12\">\r\n    <nb-card status=\"info\">\r\n      <nb-card-header class=\"d-flex justify-content-between\">Jobs list\r\n        <button nbButton status=\"success\" size=\"small\" (click)=\"open(dialog)\">Add Job</button>\r\n      </nb-card-header>\r\n      <nb-card-body>\r\n        <table class=\"table table-striped table-hover\">\r\n          <thead>\r\n          <tr>\r\n            <th *ngFor=\"let head of headElements\" scope=\"col\">{{head}}</th>\r\n          </tr>\r\n          </thead>\r\n          <tbody>\r\n            <tr *ngFor=\"let job of jobs; index as i\">\r\n              <th scope=\"row\">{{ i + 1 }}</th>\r\n              <td>{{job.name}}</td>\r\n              <td>{{job.department}}</td>\r\n              <td>{{job.scope}}</td>\r\n              <!-- <td>{{job.hazardLevel}} <ngb-rating [(rate)]=\"job.rating\" [max]=\"3\" [ngStyle]=\"{'color': getColor(job.rating)}\"></ngb-rating></td> -->\r\n              <td>{{job.technician}}</td>\r\n              <td><button nbButton hero status=\"{{job.status}}\" size=\"small\">{{job.statusMessage}}</button></td>\r\n              <td><i class=\"nb-edit\" (click)=\"editJob(dialog, job)\"></i></td>\r\n              <td><a [routerLink]=\"job.link\">Details</a></td>\r\n            </tr>\r\n          </tbody>\r\n        </table>\r\n      </nb-card-body>\r\n    </nb-card>\r\n  </div>\r\n\r\n</div>\r\n\r\n\r\n<ng-template #dialog let-data let-ref=\"dialogRef\">\r\n  <nb-card style=\"width: 40em;\">\r\n    <nb-card-header>Add Job\r\n      <a (click)=\"ref.close()\" aria-label=\"Back\" style=\"float: right;\">\r\n        <nb-icon icon=\"close\"></nb-icon>\r\n      </a>\r\n    </nb-card-header>\r\n    <nb-card-body>\r\n      <form [formGroup]=\"jobForm\">\r\n        <div class=\"form-group\">\r\n          <input type=\"text\" nbInput fullWidth id=\"inputName\" placeholder=\"Name\" formControlName=\"name\">\r\n        </div>\r\n        <div class=\"form-group d-flex justify-content-between\">\r\n          <nb-select fullWidth id=\"inputScope\" placeholder=\"Scope\" formControlName=\"scope\" selected=\"1\">\r\n            <nb-option value=\"1\">Scope 1</nb-option>\r\n            <nb-option value=\"2\">Scope 2</nb-option>\r\n          </nb-select>\r\n          <!-- <nb-icon class=\"show\" icon=\"plus-square-outline\" *ngIf=\"!compAddWrap\" (click)=\"compAddWrap=true\"></nb-icon>\r\n          <nb-icon class=\"hide\" icon=\"close-outline\" *ngIf=\"compAddWrap\" (click)=\"compAddWrap=false\"></nb-icon> -->\r\n        </div>\r\n        <div class=\"form-group d-flex justify-content-between\">\r\n          <nb-select fullWidth id=\"inputTechnician\" placeholder=\"Technician\" formControlName=\"technician\" selected=\"1\">\r\n            <nb-option value=\"1\">Mike</nb-option>\r\n            <nb-option value=\"2\">Tom</nb-option>\r\n            <nb-option value=\"3\">Dave</nb-option>\r\n          </nb-select>\r\n          <!-- <nb-icon class=\"show\" icon=\"plus-square-outline\" *ngIf=\"!compAddWrap\" (click)=\"compAddWrap=true\"></nb-icon>\r\n            <nb-icon class=\"hide\" icon=\"close-outline\" *ngIf=\"compAddWrap\" (click)=\"compAddWrap=false\"></nb-icon> -->\r\n        </div>\r\n        <div class=\"form-group\">\r\n          <!-- <nb-select fullWidth id=\"inputLocation\" placeholder=\"Location\" formControlName=\"locale\" selected=\"1\">\r\n            <nb-option value=\"1\">Kiambu</nb-option>\r\n            <nb-option value=\"2\">Thika</nb-option>\r\n          </nb-select> -->\r\n          <ngx-search-map></ngx-search-map>\r\n\r\n          <!-- <nb-icon class=\"show\" icon=\"plus-square-outline\" *ngIf=\"!compAddWrap\" (click)=\"compAddWrap=true\"></nb-icon>\r\n            <nb-icon class=\"hide\" icon=\"close-outline\" *ngIf=\"compAddWrap\" (click)=\"compAddWrap=false\"></nb-icon> -->\r\n        </div>\r\n      </form>\r\n    </nb-card-body>\r\n    <nb-card-footer>\r\n      <button nbButton status=\"success\" size=\"small\" style=\"float: right;\">submit</button>\r\n    </nb-card-footer>\r\n  </nb-card>\r\n</ng-template>\r\n"

/***/ }),

/***/ "./node_modules/raw-loader/index.js!./src/app/ohs/scope/scope.component.html":
/*!**************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/ohs/scope/scope.component.html ***!
  \**************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "<div class=\"row\">\r\n  <div class=\"col-md-6 col-sm-12\">\r\n    <nb-card status=\"info\">\r\n      <nb-card-header>Scopes of work\r\n        <button nbButton status=\"success\" size=\"small\" (click)=\"open(dialog)\">Add Scope</button>\r\n      </nb-card-header>\r\n      <nb-card-body>\r\n\r\n        <nb-card class=\"col-sm-12 p-0 work-card\" *ngFor=\"let work of works\">\r\n          <nb-card-body>\r\n            <div class=\"work-title\">{{work.name}}</div>\r\n            <div class=\"work-details\"><span class=\"work-data\">Hazard Level:</span><span class=\"fetched-data\">{{work.risk}}</span></div>\r\n            <div class=\"work-details\"><span class=\"work-data\">Activity:</span> <span class=\"fetched-data\">{{work.activity}}</span></div>\r\n            <div class=\"work-details\"><span class=\"work-data\">Hazard:</span> <span class=\"fetched-data\">{{work.hazard}}</span></div>\r\n            <div class=\"work-details\"><span class=\"work-data\">Control:</span> <span class=\"fetched-data\">{{work.control}}</span></div>\r\n          </nb-card-body>\r\n        </nb-card>\r\n\r\n      </nb-card-body>\r\n    </nb-card>\r\n  </div>\r\n  <div class=\"col-md-6 col-sm-12\">\r\n    <nb-card status=\"info\">\r\n      <nb-card-header>Hazards\r\n        <button nbButton status=\"success\" size=\"small\" (click)=\"openHazform(dialog1)\">Add Hazard</button>\r\n      </nb-card-header>\r\n      <nb-card-body>\r\n\r\n        <nb-card class=\"col-sm-12 p-0 work-card\" *ngFor=\"let haz of hazards\">\r\n          <nb-card-body>\r\n            <div class=\"work-title\">{{haz.name}}</div>\r\n            <div class=\"work-details\"><span class=\"work-data\">Consequences:</span> <span class=\"fetched-data\">{{haz.consequence}}</span></div>\r\n            <div class=\"work-details\"><span class=\"work-data\">Control:</span><span class=\"fetched-data\">{{haz.control}}</span></div>\r\n          </nb-card-body>\r\n        </nb-card>\r\n\r\n      </nb-card-body>\r\n    </nb-card>\r\n  </div>\r\n</div>\r\n\r\n\r\n<!-- <div class=\"row\">\r\n</div> -->\r\n\r\n<ng-template #dialog let-data let-ref=\"dialogRef\">\r\n  <nb-card style=\"width: 25em;\">\r\n    <nb-card-header>Add Scope\r\n      <a (click)=\"ref.close()\" aria-label=\"Back\" style=\"float: right;\">\r\n        <nb-icon icon=\"close\"></nb-icon>\r\n      </a>\r\n    </nb-card-header>\r\n    <nb-card-body>\r\n      <form [formGroup]=\"workForm\">\r\n        <div class=\"form-group\">\r\n          <input type=\"text\" nbInput fullWidth id=\"inputName\" placeholder=\"Scope of work\" formControlName=\"name\">\r\n        </div>\r\n        <div class=\"form-group d-flex justify-content-between\">\r\n          <nb-select fullWidth id=\"inputDepartment\" placeholder=\"Department\" formControlName=\"department\" selected=\"1\">\r\n            <nb-option value=\"1\">Bts-rollout</nb-option>\r\n            <nb-option value=\"2\">Fiber-rollout</nb-option>\r\n          </nb-select>\r\n        </div>\r\n        <div class=\"form-group d-flex justify-content-between\">\r\n          <nb-select fullWidth id=\"inputRisk\" placeholder=\"Risk\" formControlName=\"risk\" selected=\"1\">\r\n            <nb-option value=\"1\">Low</nb-option>\r\n            <nb-option value=\"2\">Medium</nb-option>\r\n            <nb-option value=\"3\">High</nb-option>\r\n          </nb-select>\r\n        </div>\r\n        <div class=\"form-group d-flex justify-content-between\">\r\n          <nb-select fullWidth id=\"inputActivity\" placeholder=\"Activity\" formControlName=\"activity\" selected=\"1\">\r\n            <nb-option value=\"1\">Clearing buses</nb-option>\r\n            <nb-option value=\"2\">Digging</nb-option>\r\n            <nb-option value=\"3\">Trenching</nb-option>\r\n          </nb-select>\r\n          <div class=\"icons\">\r\n            <nb-icon class=\"show\" icon=\"plus-square-outline\" *ngIf=\"!addActivity\" (click)=\"addActivity=true\"></nb-icon>\r\n            <nb-icon class=\"hide\" icon=\"close-outline\" *ngIf=\"addActivity\" (click)=\"addActivity=false\"></nb-icon>\r\n          </div>\r\n        </div>\r\n        <div class=\"form-group item-add\" *ngIf=\"addActivity\">\r\n          <input type=\"text\" nbInput fullWidth id=\"inputAct\" placeholder=\"Add activity\">\r\n          <button nbButton hero status=\"info\" size=\"small\" class=\"add-btn\">add</button>\r\n        </div>\r\n\r\n\r\n        <div class=\"form-group d-flex justify-content-between\">\r\n          <nb-select fullWidth id=\"inputHazard\" placeholder=\"Hazard\" formControlName=\"hazard\" selected=\"1\">\r\n            <nb-option value=\"1\">Snakes</nb-option>\r\n            <nb-option value=\"2\">Fire</nb-option>\r\n          </nb-select>\r\n        </div>\r\n        <div class=\"form-group d-flex justify-content-between\">\r\n          <nb-select fullWidth id=\"inputControl\" placeholder=\"Control\" formControlName=\"control\" selected=\"1\">\r\n            <nb-option value=\"1\">Safety first</nb-option>\r\n            <nb-option value=\"2\">Wash your hands</nb-option>\r\n          </nb-select>\r\n          <div class=\"icons\">\r\n            <nb-icon class=\"show\" icon=\"plus-square-outline\" *ngIf=\"!addControl\" (click)=\"addControl=true\"></nb-icon>\r\n            <nb-icon class=\"hide\" icon=\"close-outline\" *ngIf=\"addControl\" (click)=\"addControl=false\"></nb-icon>\r\n          </div>\r\n        </div>\r\n        <div class=\"form-group item-add\" *ngIf=\"addControl\">\r\n          <input type=\"text\" nbInput fullWidth id=\"inputCont\" placeholder=\"Add Control\">\r\n          <button nbButton hero status=\"info\" size=\"small\" class=\"add-btn\">add</button>\r\n        </div>\r\n      </form>\r\n    </nb-card-body>\r\n    <nb-card-footer>\r\n      <button nbButton status=\"success\" size=\"small\" style=\"float: right;\" (click)=\"addScope(workForm.value)\">submit</button>\r\n    </nb-card-footer>\r\n  </nb-card>\r\n</ng-template>\r\n\r\n\r\n<ng-template #dialog1 let-data let-ref=\"dialogRef\">\r\n  <nb-card style=\"width: 25em;\">\r\n    <nb-card-header>Add Hazard\r\n      <a (click)=\"ref.close()\" aria-label=\"Back\" style=\"float: right;\">\r\n        <nb-icon icon=\"close\"></nb-icon>\r\n      </a>\r\n    </nb-card-header>\r\n    <nb-card-body>\r\n      <form [formGroup]=\"hazForm\">\r\n        <div class=\"form-group\">\r\n          <input type=\"text\" nbInput fullWidth id=\"inputName\" placeholder=\"Hazard name\" formControlName=\"name\">\r\n        </div>\r\n        <div class=\"form-group\">\r\n          <input type=\"text\" nbInput fullWidth id=\"inputConsequence\" placeholder=\"Consequences\" formControlName=\"consequence\">\r\n        </div>\r\n        <div class=\"form-group d-flex justify-content-between\">\r\n          <nb-select fullWidth id=\"inputControl\" placeholder=\"Control\" formControlName=\"control\" selected=\"1\">\r\n            <nb-option value=\"1\">Safety first</nb-option>\r\n            <nb-option value=\"2\">Wash your hands</nb-option>\r\n          </nb-select>\r\n          <div class=\"icons\">\r\n            <nb-icon class=\"show\" icon=\"plus-square-outline\" *ngIf=\"!addHazardControl\" (click)=\"addHazardControl=true\"></nb-icon>\r\n            <nb-icon class=\"hide\" icon=\"close-outline\" *ngIf=\"addHazardControl\" (click)=\"addHazardControl=false\"></nb-icon>\r\n          </div>\r\n        </div>\r\n        <div class=\"form-group item-add\" *ngIf=\"addHazardControl\">\r\n          <input type=\"text\" nbInput fullWidth id=\"inputCont\" placeholder=\"Add Control\">\r\n          <button nbButton hero status=\"info\" size=\"small\" class=\"add-btn\">add</button>\r\n        </div>\r\n      </form>\r\n    </nb-card-body>\r\n    <nb-card-footer>\r\n      <button nbButton status=\"success\" size=\"small\" style=\"float: right;\">submit</button>\r\n    </nb-card-footer>\r\n  </nb-card>\r\n</ng-template>\r\n"

/***/ }),

/***/ "./src/app/ohs/documents/document.component.scss":
/*!*******************************************************!*\
  !*** ./src/app/ohs/documents/document.component.scss ***!
  \*******************************************************/
/*! no static exports found */
...
module.exports = "nb-card nb-card-header {\n  display: flex;\n  justify-content: space-between; }\n\nnb-card nb-card-body .work-card {\n  cursor: pointer;\n  box-shadow: 1px 1px 2px 2px rgba(0, 0, 0, 0.2); }\n\nnb-card nb-card-body .work-card:hover {\n    box-shadow: 0 0 5px 6px rgba(0, 0, 0, 0.2);\n    transition: all 0.2s ease-in-out; }\n\nnb-card nb-card-body .work-card .work-title {\n    font-size: 1em;\n    font-weight: bold;\n    font-family: Montserrat;\n    font-style: normal; }\n\nnb-card nb-card-body .work-card .work-data {\n    margin-right: 5px;\n    letter-spacing: 0.02125em;\n    font-size: 11px; }\n\nnb-card nb-card-body .work-card .doc-btn {\n    height: 20px;\n    width: 100px;\n    padding: 0;\n    text-transform: capitalize; }\n\nnb-card nb-card-body .work-card .fetched-data {\n    font-family: Montserrat;\n    font-style: normal;\n    font-size: 13px;\n    margin-left: 5px;\n    letter-spacing: 0.05em;\n    font-weight: bolder; }\n\nnb-card nb-card-body .work-card .actions {\n    color: #3366ff;\n    cursor: pointer; }\n\nnb-card nb-card-body .work-card .actions a {\n      color: #3366ff;\n      margin-right: 5px;\n      letter-spacing: 0.02125em;\n      font-size: 11px; }\n\nnb-card nb-card-body .work-card .actions a:hover {\n        text-decoration: underline; }\n\n.approver-card .work-details {\n  display: flex;\n  justify-content: space-between;\n  margin: 20px; }\n\n.approver-card .work-data {\n  margin-right: 5px;\n  letter-spacing: 0.02125em;\n  font-size: 11px; }\n\n.approver-card .fetched-data {\n  margin: -8px 15px; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/ohs/documents/document.component.ts":
/*!*****************************************************!*\
  !*** ./src/app/ohs/documents/document.component.ts ***!
  \*****************************************************/
...
var DocumentComponent = /** @class */ (function () {
    function DocumentComponent(dialogService, fb) {
        ...
        this.documents = [
            {
                name: 'Tool box form',
                file: '',
                description: 'Tool box is updated',
                status: 'warning',
                statusMessage: 'Pending',
                hod: "Phanuel Diang'a",
                projectManager: 'Violet Nawire',
                technician: 'Hosea Kiplagat',
            },
            {
                name: 'Incident form',
                file: '',
                description: 'No incidence today',
                status: 'success',
                statusMessage: 'Approved',
                hod: "Phanuel Diang'a",
                projectManager: 'Robert Odhams',
                technician: 'Faith Koech',
            },
            {
                name: 'Job hazard form',
                file: '',
                description: 'Not clearly defined',
                status: 'danger',
                statusMessage: 'Rejected',
                hod: "Phanuel Diang'a",
                projectManager: 'Solomon Adenya',
                technician: 'Kimani Kiplagat',
            },
        ];
    ...
    DocumentComponent.prototype.addDocumnet = function (post) {
        this.name = post.name;
        this.file = post.file;
        this.description = post.description;
    };
    DocumentComponent.prototype.open = function (dialog) {
        this.dialogService.open(dialog, { context: 'this is some additional data passed to dialog' });
    };
    DocumentComponent.prototype.openDetails = function (dialog1, doc) {
        this.dialogService.open(dialog1, { context: 'this is some additional data passed to dialog' });
        this.hod = doc.hod;
        this.pm = doc.projectManager;
        this.technician = doc.technician;
        if (doc.statusMessage === 'Approved') {
            this.state = 'success';
        }
        if (doc.statusMessage === 'Pending') {
            this.state = 'warning';
        }
        if (doc.statusMessage === 'Rejected') {
            this.state = 'danger';
        }
    };
    DocumentComponent.prototype.openDocs = function (dialog2, doc) {
        this.dialogService.open(dialog2, { context: 'this is some additional data passed to dialog' });
        this.file = doc;
    };
    DocumentComponent.prototype.toggle = function (checked) {
    ...
    DocumentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            ...
            template: __webpack_require__(/*! raw-loader!./document.component.html */ "./node_modules/raw-loader/index.js!./src/app/ohs/documents/document.component.html"),
            styles: [__webpack_require__(/*! ./document.component.scss */ "./src/app/ohs/documents/document.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_nebular_theme__WEBPACK_IMPORTED_MODULE_3__["NbDialogService"],
...
/***/ "./src/app/ohs/job/job-details/job-detail.component.scss":
/*!***************************************************************!*\
  !*** ./src/app/ohs/job/job-details/job-detail.component.scss ***!
  \***************************************************************/
/*! no static exports found */
...
module.exports = ".detail-card {\n  cursor: pointer;\n  box-shadow: 1px 1px 2px 2px rgba(0, 0, 0, 0.2); }\n  .detail-card:hover {\n    box-shadow: 0 0 5px 6px rgba(0, 0, 0, 0.2);\n    transition: all 0.2s ease-in-out; }\n  .detail-card nb-card-header {\n    display: flex;\n    justify-content: center;\n    padding: 5px;\n    border-bottom: none; }\n  .detail-card nb-card-header .detail {\n      font-weight: bold;\n      font-style: normal;\n      font-size: 0.75em;\n      color: #ffaa00; }\n  .detail-card nb-card-body {\n    display: flex;\n    justify-content: center;\n    padding: 10px; }\n  .detail-card nb-card-body .fetched-data {\n      font-style: normal;\n      font-size: 1em;\n      font-family: Montserrat; }\n  .detail-card nb-card-body nb-icon {\n      font-size: 1.25em;\n      margin: 0 5px; }\n  .image-card {\n  box-shadow: 1px 1px 2px 2px rgba(0, 0, 0, 0.2); }\n  .image-card nb-card-body {\n    padding: 0; }\n  .image-card .safety {\n    width: 100%;\n    height: 100%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/ohs/job/job-details/job-detail.component.ts":
/*!*************************************************************!*\
  !*** ./src/app/ohs/job/job-details/job-detail.component.ts ***!
  \*************************************************************/
...
var JobDetailComponent = /** @class */ (function () {
    function JobDetailComponent(location) {
        this.location = location;
        this.alive = true;
        this.job = {
            name: { title: 'NAME', name: 'Job 1' },
            scope: 'Trenching',
            technician: { title: 'TECHNICIAN', name: 'Hosea Malala' },
            hod: { title: 'DIVISION HEAD', name: "Phanuel Diang'a" },
            hazard: { title: 'HAZARD LEVEL', name: 'High', level: 3 },
            status: { title: 'STATUS', name: 'success', message: 'Completed' },
            department: 'fiber',
            location: 'Thika',
            link: '/operations/ohs/job-detail',
        };
        this.images = ['Image 1', 'Image 2', 'Image 3', 'Image 4'];
    }
    JobDetailComponent.prototype.back = function () {
        this.location.back();
        return false;
    };
    JobDetailComponent.prototype.getColor = function (rating) {
        switch (rating) {
            case 3:
                return 'red';
            case 2:
    ...
    JobDetailComponent.ctorParameters = function () { return [
        { type: _angular_common__WEBPACK_IMPORTED_MODULE_2__["Location"] }
    ]; };
    JobDetailComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'ngx-job-detail',
            template: __webpack_require__(/*! raw-loader!./job-detail.component.html */ "./node_modules/raw-loader/index.js!./src/app/ohs/job/job-details/job-detail.component.html"),
            styles: [__webpack_require__(/*! ./job-detail.component.scss */ "./src/app/ohs/job/job-details/job-detail.component.scss")]
        }),
...
/***/ "./src/app/ohs/job/job-incidents/job-incident.component.scss":
/*!*******************************************************************!*\
  !*** ./src/app/ohs/job/job-incidents/job-incident.component.scss ***!
  \*******************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJzcmMvYXBwL29ocy9qb2Ivam9iLWluY2lkZW50cy9qb2ItaW5jaWRlbnQuY29tcG9uZW50LnNjc3MifQ== */"

/***/ }),

/***/ "./src/app/ohs/job/job-incidents/job-incident.component.ts":
/*!*****************************************************************!*\
  !*** ./src/app/ohs/job/job-incidents/job-incident.component.ts ***!
  \*****************************************************************/
/*! exports provided: JobIncidentComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "JobIncidentComponent", function() { return JobIncidentComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _nebular_theme__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @nebular/theme */ "./node_modules/@nebular/theme/fesm5/index.js");
...
var JobIncidentComponent = /** @class */ (function () {
    function JobIncidentComponent(dialogService, fb) {
        this.dialogService = dialogService;
        this.fb = fb;
        this.alive = true;
        this.headElements = [
        ...
        this.incidents = [
            {
                name: 'Incident 1',
                description: 'Casual fell from first floor',
            },
            {
                name: 'Incident 2',
                description: 'Casual injured while trenching',
            },
        ];
    ...
    JobIncidentComponent.prototype.ngOnDestroy = function () {
        this.alive = false;
    };
    JobIncidentComponent.prototype.openIncidentform = function (dialog) {
        this.dialogService.open(dialog, { context: 'this is some additional data passed to dialog' });
    };
    JobIncidentComponent.ctorParameters = function () { return [
        { type: _nebular_theme__WEBPACK_IMPORTED_MODULE_3__["NbDialogService"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
    JobIncidentComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'ngx-job-incident',
            template: __webpack_require__(/*! raw-loader!./job-incident.component.html */ "./node_modules/raw-loader/index.js!./src/app/ohs/job/job-incidents/job-incident.component.html"),
            styles: [__webpack_require__(/*! ./job-incident.component.scss */ "./src/app/ohs/job/job-incidents/job-incident.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_nebular_theme__WEBPACK_IMPORTED_MODULE_3__["NbDialogService"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
    ], JobIncidentComponent);
    return JobIncidentComponent;
}());
...
/***/ "./src/app/ohs/job/job.component.ts":
/*!******************************************!*\
  !*** ./src/app/ohs/job/job.component.ts ***!
  \******************************************/
...
var JobComponent = /** @class */ (function () {
    function JobComponent(dialogService, fb) {
        this.dialogService = dialogService;
        this.fb = fb;
        this.alive = true;
        this.name = '';
        ...
        this.locale = '';
        this.headElements = [
            'ITEM', 'NAME', 'DEPARTMENT', 'SCOPE NAME', 'TECHNICIAN', 'STATUS', 'EDIT', 'VIEW',
        ];
        this.jobs = [
            {
                name: 'Job 1',
                scope: 'Trenching',
                technician: 'Hosea Malala',
                department: 'fiber',
                hazardLevel: 'High',
                rating: 3,
                status: 'success',
            ...
            {
                name: 'Job 3',
                scope: 'Manhole Installation',
                technician: 'Ruth Chebet',
                department: 'fiber',
                hazardLevel: 'Low',
                rating: 1,
                status: 'warning',
        ...
        this.jobForm = this.fb.group({
            'name': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            'scope': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            'technician': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            'locale': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
        });
    }
    JobComponent.prototype.addJob = function (post) {
        this.name = post.name;
        this.scope = post.scope;
        this.technician = post.technician;
        this.locale = post.locale;
        this.jobs.push(post);
    };
    JobComponent.prototype.open = function (dialog) {
        this.dialogService.open(dialog, { context: 'this is some additional data passed to dialog' });
    };
    JobComponent.prototype.editJob = function (dialog, job) {
        this.dialogService.open(dialog, { context: 'this is some additional data passed to dialog' });
        // console.log(job);
    };
    // viewJobDetails() {
    //   this.router.navigate(['/operations/ohs/document'])
    // }
    ...
    JobComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'ngx-job',
            template: __webpack_require__(/*! raw-loader!./job.component.html */ "./node_modules/raw-loader/index.js!./src/app/ohs/job/job.component.html"),
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_nebular_theme__WEBPACK_IMPORTED_MODULE_3__["NbDialogService"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
    ], JobComponent);
...
/***/ "./src/app/ohs/ohs-menu.ts":
/*!*********************************!*\
  !*** ./src/app/ohs/ohs-menu.ts ***!
  \*********************************/
/*! exports provided: OHSMENU_ITEMS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OHSMENU_ITEMS", function() { return OHSMENU_ITEMS; });
var OHSMENU_ITEMS = [
    // {
    //   title: 'Dashboard',
...
/***/ "./src/app/ohs/ohs-routing.module.ts":
/*!*******************************************!*\
  !*** ./src/app/ohs/ohs-routing.module.ts ***!
  \*******************************************/
/*! exports provided: OhsRoutingModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OhsRoutingModule", function() { return OhsRoutingModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm5/router.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ohs_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ohs.component */ "./src/app/ohs/ohs.component.ts");
/* harmony import */ var _scope_scope_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./scope/scope.component */ "./src/app/ohs/scope/scope.component.ts");
/* harmony import */ var _job_job_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./job/job.component */ "./src/app/ohs/job/job.component.ts");
/* harmony import */ var _documents_document_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./documents/document.component */ "./src/app/ohs/documents/document.component.ts");
/* harmony import */ var _job_job_details_job_detail_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./job/job-details/job-detail.component */ "./src/app/ohs/job/job-details/job-detail.component.ts");
/* harmony import */ var _job_job_incidents_job_incident_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./job/job-incidents/job-incident.component */ "./src/app/ohs/job/job-incidents/job-incident.component.ts");
...
var routes = [{
        path: '',
        component: _ohs_component__WEBPACK_IMPORTED_MODULE_3__["OhsComponent"],
        children: [
            {
                path: 'scope&hazard',
                component: _scope_scope_component__WEBPACK_IMPORTED_MODULE_4__["ScopeComponent"],
            },
            {
                path: 'job',
                component: _job_job_component__WEBPACK_IMPORTED_MODULE_5__["JobComponent"],
            },
            {
                path: 'document',
                component: _documents_document_component__WEBPACK_IMPORTED_MODULE_6__["DocumentComponent"],
            },
            {
                path: 'job-detail',
                component: _job_job_details_job_detail_component__WEBPACK_IMPORTED_MODULE_7__["JobDetailComponent"],
            },
            {
                path: 'job-incident',
                component: _job_job_incidents_job_incident_component__WEBPACK_IMPORTED_MODULE_8__["JobIncidentComponent"],
            },
            {
                path: '',
                redirectTo: 'scope&hazard',
                pathMatch: 'full',
            },
        ],
    }];
var OhsRoutingModule = /** @class */ (function () {
    function OhsRoutingModule() {
    }
    OhsRoutingModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            imports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(routes)],
            exports: [_angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"]],
        })
    ], OhsRoutingModule);
    return OhsRoutingModule;
}());
...
/***/ "./src/app/ohs/ohs.component.ts":
/*!**************************************!*\
  !*** ./src/app/ohs/ohs.component.ts ***!
  \**************************************/
/*! exports provided: OhsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OhsComponent", function() { return OhsComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ohs_menu__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ohs-menu */ "./src/app/ohs/ohs-menu.ts");
...
var OhsComponent = /** @class */ (function () {
    function OhsComponent() {
        this.menu = _ohs_menu__WEBPACK_IMPORTED_MODULE_2__["OHSMENU_ITEMS"];
        this.userToken = localStorage.getItem('currentUserToken');
        this.loggedInUser = jwt_decode__WEBPACK_IMPORTED_MODULE_3__(this.userToken);
    }
    OhsComponent.prototype.ngOnInit = function () {
        if (this.loggedInUser.role !== 'SUPERUSER') {
            this.menu.splice(3);
        }
    };
    OhsComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'ngx-ohs',
...
/***/ "./src/app/ohs/ohs.module.ts":
/*!***********************************!*\
  !*** ./src/app/ohs/ohs.module.ts ***!
  \***********************************/
/*! exports provided: OhsModule */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "OhsModule", function() { return OhsModule; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _ohs_routing_module__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ohs-routing.module */ "./src/app/ohs/ohs-routing.module.ts");
...
/* harmony import */ var _ohs_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ohs.component */ "./src/app/ohs/ohs.component.ts");
/* harmony import */ var _scope_scope_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./scope/scope.component */ "./src/app/ohs/scope/scope.component.ts");
/* harmony import */ var _job_job_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./job/job.component */ "./src/app/ohs/job/job.component.ts");
/* harmony import */ var _documents_document_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./documents/document.component */ "./src/app/ohs/documents/document.component.ts");
/* harmony import */ var _job_job_details_job_detail_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./job/job-details/job-detail.component */ "./src/app/ohs/job/job-details/job-detail.component.ts");
/* harmony import */ var _job_job_incidents_job_incident_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./job/job-incidents/job-incident.component */ "./src/app/ohs/job/job-incidents/job-incident.component.ts");
/* harmony import */ var _operations_maps_maps_module__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../operations/maps/maps.module */ "./src/app/operations/maps/maps.module.ts");
...
var OhsModule = /** @class */ (function () {
    function OhsModule() {
    }
    OhsModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            imports: [
                _ohs_routing_module__WEBPACK_IMPORTED_MODULE_2__["OhsRoutingModule"],
                ...
                _nebular_theme__WEBPACK_IMPORTED_MODULE_5__["NbSearchModule"],
                _nebular_theme__WEBPACK_IMPORTED_MODULE_5__["NbDialogModule"],
                ...
                _operations_maps_maps_module__WEBPACK_IMPORTED_MODULE_13__["MapsModule"],
                _nebular_theme__WEBPACK_IMPORTED_MODULE_5__["NbLayoutModule"],
            ...
            declarations: [
                _ohs_component__WEBPACK_IMPORTED_MODULE_7__["OhsComponent"],
                _scope_scope_component__WEBPACK_IMPORTED_MODULE_8__["ScopeComponent"],
                _job_job_component__WEBPACK_IMPORTED_MODULE_9__["JobComponent"],
                _documents_document_component__WEBPACK_IMPORTED_MODULE_10__["DocumentComponent"],
                _job_job_details_job_detail_component__WEBPACK_IMPORTED_MODULE_11__["JobDetailComponent"],
                _job_job_incidents_job_incident_component__WEBPACK_IMPORTED_MODULE_12__["JobIncidentComponent"],
            ],
            providers: [],
        })
    ], OhsModule);
...
/***/ "./src/app/ohs/scope/scope.component.scss":
/*!************************************************!*\
  !*** ./src/app/ohs/scope/scope.component.scss ***!
  \************************************************/
/*! no static exports found */
...
module.exports = "nb-card nb-card-header {\n  display: flex;\n  justify-content: space-between; }\n\nnb-card nb-card-body .work-card {\n  cursor: pointer;\n  box-shadow: 1px 1px 2px 2px rgba(0, 0, 0, 0.2); }\n\nnb-card nb-card-body .work-card:hover {\n    box-shadow: 0 0 5px 6px rgba(0, 0, 0, 0.2);\n    transition: all 0.2s ease-in-out; }\n\nnb-card nb-card-body .work-card .work-title {\n    font-size: 1em;\n    font-weight: bold;\n    font-family: Montserrat;\n    font-style: normal;\n    color: #ffaa00;\n    text-decoration: underline; }\n\nnb-card nb-card-body .work-card .work-data {\n    margin-right: 5px;\n    letter-spacing: 0.02125em;\n    font-size: 11px; }\n\nnb-card nb-card-body .work-card .fetched-data {\n    font-family: Montserrat;\n    font-style: normal;\n    font-size: 13px;\n    margin-left: 5px;\n    letter-spacing: 0.05em;\n    font-weight: bolder; }\n\n.form-group {\n  margin: 20px 10px; }\n\n.form-group .icons {\n    width: 15%;\n    display: flex;\n    justify-content: center; }\n\n.form-group .icons nb-icon {\n      font-size: 1.5rem;\n      cursor: pointer;\n      margin: auto; }\n\n.form-group .icons nb-icon:hover {\n        font-size: 1.6rem; }\n\n.form-group .icons .show {\n      color: #3366ff; }\n\n.form-group .icons .hide {\n      color: #e40046; }\n\n.item-add {\n  display: flex; }\n\n.item-add input {\n    border: none;\n    background: #ffffff;\n    border-bottom: solid 1px #0095ff; }\n\n.item-add .add-btn {\n    margin: auto 5px;\n    width: 12%;\n    height: 20px;\n    padding: 0;\n    text-transform: lowercase; }\n\n/*# sourceMappingURL=data:application/json;base64, */"

/***/ }),

/***/ "./src/app/ohs/scope/scope.component.ts":
/*!**********************************************!*\
  !*** ./src/app/ohs/scope/scope.component.ts ***!
  \**********************************************/
/*! exports provided: ScopeComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var ScopeComponent = /** @class */ (function () {
    function ScopeComponent(dialogService, fb) {
        this.dialogService = dialogService;
        this.fb = fb;
        this.alive = true;
        this.name = '';
        ...
        this.works = [
            {
                name: 'Site Clearing',
                department: 'Bts-rollout',
                risk: 'Low',
                activity: 'Clearing the site',
                hazard: 'Snakes, Wild animals and Viruses',
                control: 'Antivenom, Vaccination, Wash your hands',
            },
            {
                name: 'Trenching',
                department: 'Fiber-rollout',
                risk: 'High',
                activity: 'Digging trenches',
                hazard: 'Snakes, Wild animals and Viruses',
                control: 'Antivenom, Vaccination, Wash your hands',
            },
        ];
        this.hazards = [
            {
                name: 'Twisted leg',
                consequence: 'Injury while digging',
                control: 'Protective gear',
            },
            {
                name: 'Bitten by snake',
                consequence: 'Fatal injury',
                control: 'Antivenom',
            },
        ];
        this.workForm = this.fb.group({
            ...
            'risk': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            'activity': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            'hazard': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            'control': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
        });
        this.hazForm = this.fb.group({
            'name': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            'control': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
            'consequence': [null, _angular_forms__WEBPACK_IMPORTED_MODULE_2__["Validators"].required],
        });
    }
    ScopeComponent.prototype.addScope = function (post) {
        this.name = post.name;
        this.department = post.department;
        this.risk = post.department;
        this.activity = post.department;
        this.hazard = post.department;
        this.control = post.department;
        this.works.push(post);
    };
    ScopeComponent.prototype.open = function (dialog) {
        this.dialogService.open(dialog, { context: 'this is some additional data passed to dialog' });
    };
    ScopeComponent.prototype.openHazform = function (dialog1) {
        this.dialogService.open(dialog1, { context: 'this is some additional data passed to dialog' });
    };
    ScopeComponent.prototype.ngOnDestroy = function () {
        this.alive = false;
    };
    ScopeComponent.ctorParameters = function () { return [
        { type: _nebular_theme__WEBPACK_IMPORTED_MODULE_3__["NbDialogService"] },
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] }
    ]; };
    ScopeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'ngx-scope',
            template: __webpack_require__(/*! raw-loader!./scope.component.html */ "./node_modules/raw-loader/index.js!./src/app/ohs/scope/scope.component.html"),
            styles: [__webpack_require__(/*! ./scope.component.scss */ "./src/app/ohs/scope/scope.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_nebular_theme__WEBPACK_IMPORTED_MODULE_3__["NbDialogService"],
            _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"]])
    ], ScopeComponent);
...
//# sourceMappingURL=ohs-ohs-module-es5.js.map